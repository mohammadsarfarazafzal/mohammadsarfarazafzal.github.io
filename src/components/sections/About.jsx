        ...
        id={id}>
            <div className='flex'>
                <div className='flex flex-col'>
                    ...
                    <div className='text-lg text-[var(--color-text)] mb-8 text-justify w-2/3'>Hi there!
...
Outside of coding, I enjoy gaming and watching movies, which often spark fresh ideas for my projects. Let’s <a href="https://linkedin.com/in/mdsarfarazafzal" className="text-[var(--color-hover)] hover:underline">connect</a> and create something amazing together!</div>
                ...
                <div className='flex items-center justify-left rounded-md'>
                    <div id='pfp'><img src="../../../src/assets/pfp.jpg" alt="profilePicture" className='rounded-md' /></div>
                </div>
            </div>
        </motion.div>
    )
